...
<div className="row justify-content-center">
    <h1 style={{ color: '#4D535A', fontFamily: 'Dekko', textAlign: 'center', fontSize: '6rem', fontWeight: '900', marginBottom: '100px', textShadow: '5px 5px 5px white, 8px 8px #E2BEE8' }}>SPREAD JOY!</h1>
